            ...
            <header class="sticky top-0 z-40 bg-surface/80 dark:bg-slate-950/80 backdrop-blur-md border-b border-violet-100 dark:border-slate-800 px-8 h-20 flex items-center justify-between shrink-0">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 top-full mt-2 w-32 bg-white dark:bg-slate-800 rounded-[10px] shadow-xl border border-outline-variant/20 hidden group-hover:block overflow-hidden z-50">
                    ...
                    <!-- Theme Toggle -->
                    <button id="theme-toggle" class="w-10 h-10 rounded-[10px] flex items-center justify-center bg-white dark:bg-slate-900 border border-violet-100 dark:border-slate-800 text-primary shadow-sm hover:scale-110 active:scale-95 transition-all">
                    ...
                    <a href="{{ route('profile') }}" class="flex items-center gap-3 pl-4 border-l border-violet-100 dark:border-slate-800">
                        ...
                        <div class="w-11 h-11 rounded-[10px] border-2 border-primary/20 p-0.5 overflow-hidden shadow-lg shadow-primary/10 flex items-center justify-center bg-primary/10">
